  ...
  return (
    <div className="flex shrink-0 items-center gap-0.5">
      ...
      <button
        ...
        onClick={toggle}
        className="grid h-6 w-6 shrink-0 place-items-center rounded text-muted opacity-100 transition-colors hover:bg-surface-2 hover:text-foreground aria-expanded:opacity-100"
        aria-expanded={open}
      >
        ⋯
      </button>
